...
namespace At.Ac.FhStp.Import3D
{
    ...
    public class TexelToPixelTests
    {
        ...
        [Test]
        public void Pixel_Color_R_Is_Assimp_Texel_R_Normalized_To_01()
        {
            const byte r = 100;
            const float rNormalized = r / 255f;
            var texel = new AssimpTexel(0, 0, r, 0);

            var pixel = AssimpToModel.Texel(texel);

            Assert.AreEqual(rNormalized, pixel.r);
        }

        [Test]
        public void Pixel_Color_G_Is_Assimp_Texel_G_Normalized_To_01()
        {
            const byte g = 100;
        ...
        [Test]
        public void Pixel_Color_B_Is_Assimp_Texel_B_Normalized_To_01()
        {
            const byte b = 100;
        ...
        [Test]
        public void Pixel_Color_A_Is_Assimp_Texel_A_Normalized_To_01()
        {
            const byte a = 100;
